  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="font-display text-4xl text-[#1A1A2E]">Reconciliation</h1>
          <p className="text-sm text-[#C97B2A] font-bold uppercase tracking-wider mt-1">
            ...
            {!activeRecon ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  <div className="bg-white p-8 rounded-3xl border border-gray-100 transition-all hover:shadow-xl hover:shadow-black/5 group">
                  ...
                  <div className={`p-8 rounded-3xl border shadow-sm transition-all ${
                    ...
                    (activeRecon?.totalDiscrepancy?.amount || 0) > 0 ? 'bg-emerald-50 border-emerald-100' : 'bg-white border-gray-100'
                  }`}>
                    ...
                    <table className="w-full text-left text-sm min-w-[1000px]">
                      ...
                      <tbody className="divide-y divide-gray-50">
                        {activeRecon?.lines?.map((line) => {
                          ...
                          return (
                            <tr key={line.waiterId} className={`group hover:bg-gray-50/50 transition-colors ${
